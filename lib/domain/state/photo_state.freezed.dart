...
class _$_PhotoState implements _PhotoState {
  _$_PhotoState({this.message, this.isLoading = false});
  ...
  @override
  String toString() {
    return 'PhotoState(message: $message, isLoading: $isLoading)';
  }
...
abstract class _PhotoState implements PhotoState {
  factory _PhotoState({final String? message, final bool isLoading}) =
      _$_PhotoState;
